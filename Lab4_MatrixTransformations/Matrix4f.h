...
public:
    ...
    void InitRotation(float x, float y, float z){
        ...
        // TODO:
        rz.Set(0,0, 1);         rz.Set(0,1,0);      rz.Set(0,2,0);  rz.Set(0,3,0); 
        rz.Set(1,0, 0);         rz.Set(1,1,cos(z));      rz.Set(1,2,-sin(z));  rz.Set(1,3,0);
        rz.Set(2,0, 0);         rz.Set(2,1,sin(z));      rz.Set(2,2,-cos(z));  rz.Set(2,3,0);
        rz.Set(3,0, 0);         rz.Set(3,1,0);      rz.Set(3,2,0);  rz.Set(3,3,1);
    
        rx.Set(0,0, cos(x));         rx.Set(0,1,-sin(x));      rx.Set(0,2,0);  rx.Set(0,3,0); 
        rx.Set(1,0, sin(x));         rx.Set(1,1,cos(x));      rx.Set(1,2,0);  rx.Set(1,3,0);
        rx.Set(2,0, 0);         rx.Set(2,1,0);      rx.Set(2,2,1);  rx.Set(2,3,0);
